  ...
  return (
    <div className='py-10 lg:mt-10'>
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        ...
        <div className='my-8 border rounded-3xl border-gray-900/10 border-gray-100/10'>
          <div className='space-y-10 my-10 py-8 px-4 mx-auto sm:max-w-lg'>
            ...
            <div className='border-b-2 border-gray-200 border-gray-100/10'></div>
            <div className='space-y-4 col-span-full'>
              <h2 className='text-xl font-bold'>Uploaded Files</h2>
              {isFilesLoading && <p>Loading...</p>}
              {filesError && <p>Error: {filesError.message}</p>}
              {!!files && files.length > 0 ? (
                files.map((file: { key: string; name: string }) => (
                  <div
                    key={file.key}
