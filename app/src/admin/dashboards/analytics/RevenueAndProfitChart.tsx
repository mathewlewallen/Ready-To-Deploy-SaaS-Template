...
const RevenueAndProfitChart = ({ weeklyStats }: DailyStatsProps) => {
  ...
  return (
    <div className='col-span-12 rounded-sm border  px-5 pt-7.5 pb-5 shadow-default border-boxdark bg-boxdark sm:px-7.5 xl:col-span-8'>
      <div className='flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap'>
        ...
        <div className='flex w-full max-w-45 justify-end'>
          <div className='inline-flex items-center rounded-md  p-1.5 bg-graydark'>
            <button className='rounded  py-1 px-3 text-xs font-medium   hover:shadow-card bg-boxdark text-white hover:bg-boxdark'>
              Day
            </button>
