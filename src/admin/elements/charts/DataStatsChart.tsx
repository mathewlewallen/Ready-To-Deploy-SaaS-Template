...
const DataStatsChart = () => {
  return (
    <div className="col-span-12 rounded-sm border border-bodydark  p-7.5 shadow-default border-boxdark bg-boxdark">
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4 xl:gap-0">
        <div className="flex items-center justify-center gap-2 border-b border-bodydark pb-5 border-boxdark xl:border-b-0 xl:border-r xl:pb-0">
          <div>
            <h4 className="mb-0.5 text-xl font-semibold text-black text-white md:text-title-lg">
              4,350
            </h4>
        ...
        <div className="flex items-center justify-center gap-2 border-b border-bodydark pb-5 border-boxdark sm:border-b-0 sm:pb-0 xl:border-r">
          <div>
            <h4 className="mb-0.5 text-xl font-semibold text-black text-white md:text-title-lg">
              54%
            </h4>
