...
const TotalPayingUsersCard = ({ dailyStats, isLoading }: DailyStatsProps) => {
  ...
  return (
    <div className='rounded-sm border border-bodydark  py-6 px-7.5 shadow-default bg-boxdark'>
      <div className='flex h-11.5 w-11.5 items-center justify-center rounded-full  bg-boxdark'>
        <svg
      ...
      <div className='mt-4 flex items-end justify-between'>
        <div>
          <h4 className='text-title-md font-bold text-white'>{dailyStats?.paidUserCount}</h4>
