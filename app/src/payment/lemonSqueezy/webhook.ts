...
async function handleOrderCreated(data: Order, userId: string, prismaUserDelegate: PrismaClient['user']) {
  ...
  await updateUserLemonSqueezyPaymentDetails(
    { lemonSqueezyId, userId, lemonSqueezyCustomerPortalUrl, datePaid },
    prismaUserDelegate
  );
  ...
  await updateUserLemonSqueezyPaymentDetails(
    {
      lemonSqueezyId,
      userId,
      subscriptionStatus: 'cancelled', // cancel_at_period_end is the Stripe equivalent of LemonSqueezy's cancelled
    },
    prismaUserDelegate
  );
  ...
  await updateUserLemonSqueezyPaymentDetails(
    {
      lemonSqueezyId,
      userId,
      subscriptionStatus: 'expired', // deleted is the Stripe equivalent of LemonSqueezy's expired
    },
    prismaUserDelegate
  );
