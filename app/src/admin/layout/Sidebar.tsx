...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={cn(
        'absolute left-0 top-0 z-9999 flex h-screen w-56 flex-col  overflow-y-hidden bg-boxdark2 duration-300 ease-linear lg:static lg:translate-x-0',
        {
    ...
    >
      {/* Sidebar Header */}
      <div className="flex items-center justify-between gap-2 px-10 py-10">
        <NavLink to="/">
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* Menu Section */}
          <div>
            <h3 className="mb-2 ml-0 text-md font-semibold underline underline-offset-4 decoration-neutral-500">MENU</h3>
            ...
            <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      'group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-neutral-300 hover:text-boxdark2 hover:bg-primary',
                      {
                        'bg-primary text-boxdark2': isActive,
                      }
                    )
                  }
                >
          ...
          {/* <!-- Others Group --> */}
          <div>
          <h3 className="mb-2 ml-0 text-md font-semibold underline underline-offset-4 decoration-neutral-500">COMPONENTS</h3>
            <ul className='mb-6 flex flex-col gap-1.5'>
              {/* <!-- Menu Item Chart --> */}
              <li>
                <NavLink
                    ...
                    <React.Fragment>
                      <NavLink
                        ...
                        className={cn(
                          'group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-neutral-300 hover:text-boxdark2 hover:bg-primary',
                          {
                            'bg-primary text-boxdark2': pathname.includes('forms'),
                          }
                        )}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        ...
                        Forms
                        <svg
                          className={cn('absolute right-4 top-1/2 -translate-y-1/2 fill-bodydark', {
                            'rotate-180': open,
                          })}
                          width='20'
                          height='20'
                    ...
                    <React.Fragment>
                      <NavLink
                        ...
                        className={cn(
                          'group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-neutral-300 hover:text-boxdark2 hover:bg-primary',
                          {
                            'bg-primary text-boxdark2': pathname.includes('ui'),
                          }
                        )}
                        onClick={(e) => {
                          e.preventDefault();
